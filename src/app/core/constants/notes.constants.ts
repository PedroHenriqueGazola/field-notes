...
export const notesList: Note[] = [
  ...
  },
  {
    ...
    text: 'Nova York: visitar a Estátua da Liberdade, assistir a um musical da Broadway, fazer compras na Quinta Avenida',
  },
  {
    id: '5',
    title: 'Lista de livros',
    text: '1. "1984" de George Orwell\n2. "O Grande Gatsby" de F. Scott Fitzgerald\n3. "O Sol é para Todos" de Harper Lee',
  },
  {
    id: '6',
    title: 'Exercícios',
    text: '3 séries de 10 flexões, 3 séries de 15 agachamentos, 2 séries de 20 abdominais',
  },
  {
    id: '7',
    title: 'Pensamentos e ideias',
    text: 'Ideia de negócio: abrir uma loja de produtos naturais',
    image: 'https://i.pinimg.com/564x/63/d5/b1/63d5b1e031b5e72d80b5b8ccbea9bb76.jpg'
  }
];
